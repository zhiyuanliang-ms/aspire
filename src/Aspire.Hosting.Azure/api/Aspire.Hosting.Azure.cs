...
namespace Aspire.Hosting
{
    ...
    public static partial class AzurePublisherExtensions
    {
        ...
        public static void AddAzurePublisher(this IDistributedApplicationBuilder builder, System.Action<Azure.AzurePublisherOptions>? configureOptions = null) { }

        [System.Diagnostics.CodeAnalysis.Experimental("ASPIREPUBLISHERS001", UrlFormat = "https://aka.ms/dotnet/aspire/diagnostics#{0}")]
        public static void AddAzurePublisher(this IDistributedApplicationBuilder builder, string name, System.Action<Azure.AzurePublisherOptions>? configureOptions = null) { }
    }
